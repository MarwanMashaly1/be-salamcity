...
url = "https://gate.whapi.cloud/messages/image?token=nLk8s0eRI54Zo5n2E6r6DbJq7MNEmGIi"
for event in events:
    if event.get("is_new") == None:
        ...
        if media == None:
            url = "https://gate.whapi.cloud/messages/text?token=nLk8s0eRI54Zo5n2E6r6DbJq7MNEmGIi"
        body_parts = []
        if event.get("title"):
